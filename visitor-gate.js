...
(function(){
  ...
  function publicMode(){
    ...
    document.body.classList.add('econova-public-mode');document.documentElement.classList.remove('econova-gating');
    loadToolsEnhancer();installPublicControls();
