...
(function () {
  ...
  const dictionary = {
    en: {
      ...
      login_subtitle: "Enter your account to continue.", register_subtitle: "Join Habboub Intelligence.",
      ...
      nav_live: "Live", nav_academy: "Academy", system_online: "HABBOUB INTELLIGENCE ONLINE",
      ...
      open_session: "Open Trading Session", view_markets: "View Markets", current_score: "CURRENT HABBOUB SCORE",
      ...
      session_subtitle: "Everything you need for one trading session, in one place.", habboub_score: "Habboub Score",
      ...
      waiting_analysis: "Habboub will display the main factors here.", markets: "MARKETS", markets_title: "Market Watch",
      markets_subtitle: "Monitor the assets that matter.", intelligence_title: "Market Intelligence",
      intelligence_subtitle: "Understand what is influencing the environment.", ask_ai: "Ask Habboub AI",
      ...
      live_status: "Live Status", academy: "ACADEMY", academy_title: "Habboub Academy",
    ...
    ar: {
      ...
      register_subtitle: "انضم إلى Habboub Intelligence.", full_name: "الاسم الكامل", email: "البريد الإلكتروني",
      ...
      nav_live: "البث المباشر", nav_academy: "الأكاديمية", system_online: "نظام HABBOUB للذكاء يعمل الآن",
      hero_title_1: "افهم السوق.", hero_title_2: "تداول مع السياق.",
      hero_description: "يجمع Habboub بين هيكل السوق وسياق ICT وتمركزات COT والأحداث الاقتصادية وذكاء الذكاء الاصطناعي في بيئة تداول واضحة.",
      open_session: "فتح جلسة التداول", view_markets: "عرض الأسواق", current_score: "مؤشر HABBOUB الحالي",
      ...
      session_subtitle: "كل ما تحتاجه لجلسة تداول واحدة، في مكان واحد.", habboub_score: "مؤشر Habboub",
      ...
      full_analysis: "التحليل الكامل →", waiting: "بانتظار البيانات", waiting_analysis: "سيعرض Habboub أهم العوامل هنا.",
      markets: "الأسواق", markets_title: "مراقبة الأسواق", markets_subtitle: "راقب الأصول المهمة.",
      intelligence_title: "ذكاء السوق", intelligence_subtitle: "افهم العوامل التي تؤثر على بيئة السوق.", ask_ai: "اسأل Habboub AI",
      ...
      academy_title: "أكاديمية Habboub", academy_subtitle: "تعلّم المفاهيم التي يعتمد عليها التحليل.",
  ...
  const legacyText = {
    ...
    "TRADING INTELLIGENCE": "nav_intelligence", "HABBOUB INTELLIGENCE ONLINE": "system_online",
    "Understand the market.": "hero_title_1", "Trade with context.": "hero_title_2", "Open Trading Session": "open_session",
    "View Markets": "view_markets", "CURRENT HABBOUB SCORE": "current_score", "Market Condition": "market_condition",
    ...
    "Habboub Score": "habboub_score", "Market Context": "market_context", "Symbol": "symbol", "HTF Bias": "htf_bias",
    ...
    "Market Intelligence": "intelligence_title", "Ask Habboub AI": "ask_ai", "Current Analysis": "current_analysis",
    ...
    "Habboub Academy": "academy_title", "Loading courses...": "loading_courses", "ANNOUNCEMENTS": "announcements",
  ...
  function setLanguage(language) {
    ...
    const title = lang === "ar" ? "Habboub — ذكاء التداول" : "Habboub — Trading Intelligence";
